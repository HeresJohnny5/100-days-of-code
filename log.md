...
**Today's Progress**: I wrapped up week 2 of MongoDB University's M001: Introduction to MongoDB Basics. I spent a good chunk of time on MongoDB's documentation reinforcing what I'm learning about Update Operators. 
...
**Thoughts**: I appreciate the struggle one encounters when faced with a algorithm challenge. Regardless of how ugly the code is, I love the eureka moment one receives when solving said challenge. I also love coming across a unknown JavaScript method which will take your unruly code and make it elegant. So today, I would like to thank the [padEnd()](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/padEnd) method. The **padEnd()** method pads the current string with a given string (repeated, if needed) so that the resulting string reaches a given length. The padding is applied from the end (right) of the current string.
...
## Day 38: February 26, 2018

**Progress**: While I made some progress in *The Complete Developers Guide to MongoDB* today, I still have 11 more videos to complete before EOD Wednesday 2/28. It shouldn't be a issue, however the section deals with many advanced Mongoose operations and features. 
...
**Progress**: Today I made progress in Maximillian's React - 16 course; No different than any other coding project I learned the importance of a good directory structure. I also learned what happens during component creation. , however I made certain to get a couple hrs of code in. I dug deeper into React components and methods.

**Thoughts**: Other than seeing the Doctor I spent the majority of the day resting. Looks as if I have a upper respitory infection. Here's to hoping I get better sooner rather than later.

## Day 48: March 8, 2018

**Progress**: I suppose it's normal to have days where nothing seems to make much sense. I attempted to dive deeper into React components and React internals and came out with more questions than answers. 
